...
function QuoteHeader(props){
    return <h1 className="text-white text-center text-3xl md:text-9xl pt-2 mt-12 font-heading">{props.text}</h1>
}
...
function Paragraph(props){
    ...
    props.text.forEach((e,i)=>{
        let classes = "font-paragraph text-sm md:text-xl text-light-gray px-3 appear inline"
