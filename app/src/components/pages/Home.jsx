...
const Home = () => {
    ...
    <>
        ...
        <BackgroundImageSlide main="DESTINATIONS" label="LEARN MORE" link="/" background={`url(${moon1}`} position="topLeft" description="A short description, no longer than a paragraph"/>
        ...
        <BackgroundImageSlide main="TRAINING" label="LEARN MORE" link="/" background={`linear-gradient(rgba(0,0,0,0.2), rgba(0,0,0,0.2)), url(${training1}`} position="topLeft" description="A short description, no longer than 2 sentences." />
        <BackgroundImageSlide main="SAFETY" sub="Rest Easily In Our Craft" label="LEARN MORE" link="/" background={`url(${safety1}`} position="bottomLeft" />
        <BackgroundImageSlide main="ABOUT US" sub="You Are Our Mission" label="LEARN MORE" link="/" background={`linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(${people1}`} position="bottomLeft" />
    </>
    );
};
