...
const Home = () => {
    ...
    <>
        ...
        <BackgroundImageSlide main="TRAINING" label="LEARN MORE" link="/" background={`url(${peanuts}`} position="topLeft" description="A short description, no longer than 2 sentences." />
        <BackgroundImageSlide main="SAFETY" sub="Rest Easily In Our Craft" label="LEARN MORE" link="/" background={`url(${peanuts}`} position="bottomLeft" />
