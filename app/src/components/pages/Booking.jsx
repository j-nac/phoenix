  ...
  return (
    <>
      ...
      <ConditionalRenderer current={current} id={0}>
        ...
        <DestinationSelect forward={updateDestination} src={[Space, Orbit, Moon]} price={['1', '2', '4']} desc={['Take one of our first class shuttles to the edge of space for the day', 'Truly experience the wonders of zero Gs across 3 days of orbiting the earth', 'visit and orbit the moon. Even take one of our famous space walks']} />
      </ConditionalRenderer>
