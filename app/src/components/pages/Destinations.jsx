...
const Destinations = () => {
    return (
      <>
        ...
        <BackgroundImageSlide label="BUY NOW" link="/booking" main="ORBIT" background={`url(${peanuts}`} position="bottomLeft" description="Orbit around Earth in our luxury space station. Take a spacewalk accompanied by our experienced guides" />
