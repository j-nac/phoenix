  ...
  useEffect(() => {
    ...
    return (
      <>
        ...
        <BackgroundImageSlide label="BUY NOW" link="/#/booking" main="SPACE" background={`url(${space2}`} position="topLeft" description="With our space travel package, passengers are taken to space for gorgeous views of our planet and galaxy. Minimal training required." />
        ...
        <BackgroundImageSlide label="BUY NOW" link="/#/booking" main="MOON" background={`url(${moon}`} position="bottomLeft" description="Feel the lunar solid under your feet, leaving your imprint thousands of miles from home—an extraordinary experience bringing people closer to the stars." />
        <Footer />
      </>
    )
};
