    ...
    return (
        <div className="w-screen min-w-slide relative bg-black px-[15%] py-5">
            <div className="flex justify-center flex-wrap">
                <DestinationCard src={props.src[0]} price={props.price[0]} desc={props.desc[0]} forward={props.forward} destId={0} title="Visit Space" />
                <DestinationCard src={props.src[1]} price={props.price[1]} desc={props.desc[1]} forward={props.forward} destId={1} title="Orbit The Earth" />
